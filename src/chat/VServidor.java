...
public class VServidor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // para el server socket-> servidor de sockets que escuha a la espera que alguien se conecte
        if (servidor==null){
...
//        try{
            //el puerto que deberiamos abrir lo convertimos en entero 
//            ss= new ServerSocket(port);
//            Socket s= ss.accept();
//            JOptionPane.showMessageDialog(this, "Se ha conectado");
//        }catch(Exception e){
//            JOptionPane.showMessageDialog(this, "error al abrir el puerto. Posiblemente ya este en uso");
//        }            
//        try{
//            ss.close();
//        }catch(Exception e){
